...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 45, vars: 0, consts: [["color", "primary"], [1, "example-spacer"], ["matTooltip", "send email to developer", 1, "example-icon"], ["matTooltip", "view source code", 1, "example-icon"], [1, "grid_items"], [1, "grid_item"], [1, "example-card"], ["mat-card-avatar", "", 1, "example-header-image"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
